...
rm -f "$home/.config/wireplumber/main.lua.d/51-ae9-soft-mixer.lua" "$home/.config/wireplumber/wireplumber.conf.d/51-ae9-soft-mixer.conf" "$home/.config/systemd/user/ae9-defaults.service"
